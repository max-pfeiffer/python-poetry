...
TARGET_ARCHITECTURES: list[str] = [
    ...
    "poetry1.2.1-python3.9.14-bullseye",
    "poetry1.2.1-python3.9.14-slim-bullseye",
    "poetry1.2.1-python3.10.7-bullseye",
    "poetry1.2.1-python3.10.7-slim-bullseye",
]
BASE_IMAGES: dict = {
...
POETRY_VERSIONS: dict = {
    ...
    TARGET_ARCHITECTURES[4]: "1.2.1",
    TARGET_ARCHITECTURES[5]: "1.2.1",
    TARGET_ARCHITECTURES[6]: "1.2.1",
    TARGET_ARCHITECTURES[7]: "1.2.1",
}
